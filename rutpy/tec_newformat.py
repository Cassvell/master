...
path='/home/c-isaac/Escritorio/proyecto/tormentas-list/rutidl/tec/tec_med/'
...
df = pd.read_csv(path+code+'_'+idate+'_'+fdate+'_med.txt', header=0, \
...
ndays = len(DOY_arr)/12                #num de días que abarca la ventana de  
                                       #tiempo del archivo original
...
for i in range(0,len(idx),12):
    ...
    new_path = '/home/c-isaac/Escritorio/proyecto/tormentas-list/rutidl/tec/'
